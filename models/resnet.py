...
class ResNet(nn.Module):
    ...
    def __init__(self, block, num_block, num_classes=2):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(3, 64, kernel_size=7,stride=2, padding=3, bias=False), #原来是(3,64,3,1,1,False)
            nn.BatchNorm2d(64),
            nn.ReLU(inplace=True))
...
def resnet18():
    ...
    pretrained_dict = torch.load("/home/zhanghangning/pytorch/preTrainedCheckpoints/resnet18-5c106cde.pth", map_location='cpu')
