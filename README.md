...
如：python train.py -net  resnext50  -gpu 1
```
...
如：python test.py -net resnext50 -weights /home/tianlei/AAA-my_codes/Shichen_Zhang/pytorch-multiModels/checkpoint/resnext50/Thursday_26_June_2025_16h_26m_21s/resnext50-100-regular.pth
```
